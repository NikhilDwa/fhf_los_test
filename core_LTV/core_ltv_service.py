...
from core_LTV import coreltv_constants as c

file_path = "C:/Users/Leapfrog/fhf_los_test/core_LTV/core_rate.csv"
...
for d in csv_data:
    ...
    JBstates = [
        "IL", "MI", "CT", "MD", "VA", "NJ", "NH", "PA", "MA", "SC", "NC", "DE",
        "GA", "WI", "TN", "IN", "KY", "OH", "OK", "NY", "FL", "TX", "AL"
    ]

    KBstates = [
        "CO","ID","NV", "UT","OR", "WA","AZ","CA"
    ]

    line3ltv_totalCashprice = c.total_Cash_Price
    line3_ltv_adjustment = c.line3_ltv_adjustment
