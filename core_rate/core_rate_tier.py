...
input_file_name= "FL_CL1_SSN_AcceptanceTst.csv"
...
for d in csv_data:
    ...
    if "_550-600" in d["TESTCASE"]:
        final_rate = final_rate + dimension_rate["550-600"]
    ...
    if "_550-600" in d["TESTCASE"]:
        final_rate = final_rate+second_rate["550-600"]
    ...
    score_tier = match.group(0) if match else None
